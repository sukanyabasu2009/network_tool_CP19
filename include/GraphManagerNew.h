...
public:
	...
	void testing_printexpr_iter(t_ExpressionManager* em);
        ...
        void get_node_activation_status_relaxation_constraints_with_z3(z3::context& c, z3::solver& s, map<string, z3::expr>& all_z3_var_to_expr_map, GraphNew * graph, set<int>& nids_to_consider, set<int>& up_reg_nids, set<int>& down_reg_nids);
